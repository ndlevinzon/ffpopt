...
.. code-block::
   ...
   quit
   EOF
   [user@comp] tleap is -f tleap.in
   [user@comp] ls A.parm7 A.rst7
...
.. code-block::
   ...
   [user@comp] ffpopt-PrepareInput.py -p A.parm7 -c A.rst7 -o A.json
   [user@comp] ffpopt-FindSugarPuckers.py A.json
...
.. code-block::
   ...
   [user@comp] ffpopt-Optimize.py --norestene -i A.json -o A.opt.json 2> /dev/null
