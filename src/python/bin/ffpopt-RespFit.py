...
if __name__ == "__main__":
    ...
    parser.add_argument \
        ("--confdep",
         action='store_true',
         help="If present, write a file of conformer-dependent charges. The name of the file is the same as 'out' but the {ext} extension is replaced with .confdepqs.{ext}")
