...
class GenCalculator(Calculator):
    ...
    def __init__(self,mode,charge,spin,parm,crd,**kwargs):
        ...
        if self.mode == "SANDER":
            ...
            from . RDKitUFFCalculator import RDKitUFFCalculator
            self.calc = RDKitUFFCalculator(charge=self.charge,**kwargs)
        elif self.mode == "MMFF94":
            from . RDKitMMFF94Calculator import RDKitMMFF94Calculator
            self.calc = RDKitMMFF94Calculator(charge=self.charge,**kwargs)
