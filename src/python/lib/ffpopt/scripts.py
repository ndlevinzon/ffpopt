...
def ffpopt_antechamber():         _run_bin_script("ffpopt-antechamber.py")
def ffpopt_parmchk2():            _run_bin_script("ffpopt-parmchk2.py")
def ffpopt_tleap():               _run_bin_script("ffpopt-tleap.py")
